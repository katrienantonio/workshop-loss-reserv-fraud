...
Course materials for the online *Loss Modelling, Reserving and Insurance Fraud* course in June 2021.

`r emo::ji("calendar")` June 3, 10 & 17
<br>
...
| Day 3   | 3 - 3.30  | Motivation and fraud detection cycle | sheets in [pdf](https://katrienantonio.github.io/workshop-loss-reserv-fraud-2020/sheets/day3/2020-11-26 K Antonio Insurance Fraud Analytics_print.pdf)
...
- you should now be able to visit the ‘learn R by doing’ project and see the ‘scripts’ and ‘data’ folders on the right. Open and run the ‘installation-instructions.R’ script from the scripts folder, to see if everything works fine.
